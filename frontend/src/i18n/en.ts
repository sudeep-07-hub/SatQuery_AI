...
export const en = {
  ...
  // ── Chat thread ──
  'mic.start': 'Dictate your question',
  'mic.stop': 'Stop dictating',
  'mic.listening': 'Listening',
  'mic.stopped': 'Stopped',
  'mic.unsupported': 'Voice input needs a browser with speech recognition; this one does not have it.',
  'mic.langUnsupported': 'The speech service does not recognise {lang}. Switch the interface language, or type your question.',
  'mic.limitNote': 'Dictation stops on its own after {seconds} seconds.',
  'mic.error.notAllowed': 'Microphone access is blocked. Allow the microphone for this site in your browser settings, then press the mic again.',
  'mic.error.noSpeech': 'Nothing was heard. Check that the right microphone is selected and speak again.',
  'mic.error.audioCapture': 'No microphone was found. Connect one, then press the mic again.',
  'mic.error.network': 'Speech recognition runs as an online service and it could not be reached. Check the connection and try again.',
  'mic.error.aborted': 'Dictation stopped before anything was recognised. Press the mic to start again.',
  'mic.error.serviceNotAllowed': 'The browser blocked the speech service for this page. Check the site permissions, then press the mic again.',
  'mic.error.other': 'Dictation stopped: {code}. Press the mic to try again.',
  'mic.dismissError': 'Dismiss this message',
